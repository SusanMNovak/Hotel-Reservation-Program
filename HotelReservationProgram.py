# IS 280  Python HotelReservationProgram Susan Novak

# !/usr/bin/env python3

# import datetime class and locale module
from datetime import datetime
import locale

# obtains a valid arrival date
...
# obtains a valid departure date
def get_departure_date(arrival_date):
    while True:
        date_str = input("Enter d20212022eparture date (YYYY-MM-DD): ")
        try:
...
# obtains valid dates from above functions, calculates nights  and cost and displays results
def main():
